...
- <b> Preparing the Dataset<b><br><br> 1. Comparing the fields of the dataset, one can realises that Finland, Norway, Denmark and Sweden do not have the field "employment_status". Instead, the employment status was capture by various fields (employment_status_1, employment_status_2 etc.)<br><br> ![](images/screenshot.131.jpg) <br><br> 2. To align to the rest of the dataset, need to create the field "employment_status" and change the header to reflect the employment status ("Fulltime Employment","Not Working" etc)<br><br> ![](images/screenshot.132.jpg) <br><br> 3. Use the formula to update the value for "employment_status".<br><br> ![](images/screenshot.133.jpg) <br><br> 4. Save the file and repeat it for the rest of the countries (Norway, Denmark and Sweden). 5. For Sweden, there is a need to rename "record" to "RecordNo", to align to rest of the dataset. <br><br> ![](images/screenshot.134.jpg) <br><br>

- <b>Import data into Tableau<b> <br><br> 1. Select "Text File" from Connect Panel.<br><br>![](images/screenshot.2.jpg) <br><br> 2. Select australia.csv. <br><br>![](images/screenshot.103.jpg) <br><br>  3. Remove australia.csv from the panel. <br><br> ![](images/screenshot.3.jpg){width=100%} <br><br>  4. Click on "New Union" under the File Panel. <br><br> ![](images/screenshot.104.jpg) <br><br> 5. Import all the countries into the "New Union" panel and click OK. <br><br> ![](images/screenshot.5.jpg) <br><br>
