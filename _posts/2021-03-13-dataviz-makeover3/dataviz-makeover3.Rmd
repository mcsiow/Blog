...
| 4.    | Besides showing the location of the events that occurs, the colored circles on the map serve no other purposes. Moreover, multiple events could happened on the same location and could not be picked up by the readers. Will be good to show summation of number of events that occur on a particular location. | To provide summation information.|
...
| 4.    | No X-axis gridline for the right chart. Hard to interpret the value for the x-axis (Year).       | To include gridline for X-axis.    |
...
3. Change the CNT(Event Id Cnty) to Bar under Marks card. <br><br> ![](images/screenshot.92.jpg){width=100%}  <br><br>
4. Put Fatalities to Rows. <br><br> ![](images/screenshot.12.jpg){width=100%}  <br><br>
5. Change the Fatalities to Line under Marks card. <br><br> ![](images/screenshot.91.jpg){width=100%}  <br><br>
...
8. Choose Selected Worksheets. <br><br> ![](images/screenshot.51.jpg) <br><br>
...
11. Add in a reference line by right clicking on the pane. <br><br>![](images/screenshot.132.jpg)  <br><br>
12. Apply the filter to all the sheets.<br><br>![](images/screenshot.100.jpg)  <br><br>
...
1. Put Country and Event Date to Columns, Event Id Cnty (Change measure to Cnt) to Rows and Event Type to Color. <br><br> ![](images/screenshot.119.jpg)  <br><br> 
2. Change to Line, under Marks Card. <br><br> ![](images/screenshot.120.jpg)  <br><br>
...
1. Duplicate ByCountry. <br><br> ![](images/screenshot.123.jpg)  <br><br>
...
<br><br>![](images/screenshot.146.jpg){width=100%} <br> ![](images/screenshot.145.jpg){width=100%} <br> 
...
<br><br>![](images/screenshot.158.jpg){width=100%} <br> 
